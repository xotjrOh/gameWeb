...
export const MESSAGES = {
    ...
    NICKNAME_ALREADY_IN_USE: '이미 사용 중인 닉네임입니다. 다른 닉네임을 선택해주세요.',
    CANNOT_LEAVE_DURING_GAME: '게임이 진행 중입니다. 게임이 끝나기 전까지 방을 나갈 수 없습니다.',
    ...
    ALREADY_IN_ANOTHER_ROOM: (roomName) => `이미 참여중인 게임방(${roomName})이 있습니다.`,
};
