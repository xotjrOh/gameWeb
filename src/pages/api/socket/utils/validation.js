...
import { MESSAGES, NOT_ASSIGNED, MIN_PLAYER_LENGTH, AUTHORIZED_SESSION_IDS, GAME_STATUS } from '../utils/constants';
...
export function validateDuplicateNickname(room, nickname) {
    const isDuplicateNickname = room.players.some(player => player.name === nickname) || room.host.name === nickname;
