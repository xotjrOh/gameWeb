        ...
        <div className="space-y-4">
          ...
          {results.length === 0 && (
            <div className="text-center py-4 md:py-6">
              <h2 className="text-xl md:text-2xl font-bold text-red-500 mb-4">😢 아무도 😢</h2>
              <h2 className="text-xl md:text-2xl font-bold text-red-500 mb-4">베팅하지 않았어요!</h2>
              <p className="text-sm md:text-base text-gray-600">이렇게나 흥미진진한 라운드에</p>
              <p className="text-sm md:text-base text-gray-600">아무도 베팅을 하지 않다니... 너무 아쉽네요!</p>
